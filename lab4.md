...
Keys Pressed:
```
ssh cs15lfa23ml@ieng6.ucsd.edu <Enter>
```
...
```
git clone git@github.com:shinaegyo/lab7.git <Enter>
```

### 6)
# Showing failed test

<img width="527" alt="Screen Shot 2023-11-29 at 1 55 35 PM" src="https://github.com/shinaegyo/lab-report-4/assets/137027086/f45c2c80-0d6f-4275-b815-6e0df318c3b4">
...
Keys Pressed: 
```
vim ListExamples.java <Enter> , 43j , 11l , r2 , :wq
```
...
Keys Pressed: 
```
vim ListExamples.java <Enter> , bash test.sh
```
...
Keys Pressed: 
```
git add ListExamples.java <Enter> , git commit -m "Changed index1 to index2 in the merge method" <Enter> , git push <Enter>
```
